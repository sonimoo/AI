...
| -------------------- | ----------------------------------------- | --------------------- | ------------- |
| **Температура (°C)** | низкая, средняя, высокая                  | 0–20, 15–35, 30–50    | треугольные   |
...
правило "средняя температура + высокий UV + низная влажность = высокий риск ожога "

𝛼𝑖 = min ⁡( 𝜇 temp, 𝜇 UV, 𝜇 hum) 
𝛼𝑖 = min ⁡( 0.7 , 0.5 , 0.7 ) = 0.5 
